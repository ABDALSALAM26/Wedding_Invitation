...
if (locationIcon2) {
  locationIcon2.addEventListener("click", () => {
    ...
    window.open("https://www.google.com/maps?q=30.600691,31.490609", "_blank");
  });
}
...
form.addEventListener("submit", async (e) => {
  ...
  const formURL =
    "https://docs.google.com/forms/d/e/1FAIpQLSdZYvD6iS8Fq477TywyeZVTCyQcsAPW9RMP9oVTmWDGoRvNgw/formResponse";
